...
| **Status** | **APPROVED** — Phase 0 ❄️ FROZEN 2026-09-02; Phase 1 ready to begin |
| **Owner** | Product owner |
...
| **Last updated** | 2026-09-02 — D43 resolved `OQ-B06`; Phase 0 frozen |
...
| **1** | V2 foundation — auth, profile, PostgreSQL | **NEXT — ready to begin** |
